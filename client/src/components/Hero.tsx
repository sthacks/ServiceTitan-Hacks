            ...
            <div className={`flex flex-col sm:flex-row items-center ${backgroundImage ? 'justify-start' : 'justify-center'} gap-4`}>
              ...
              {secondaryCta && (
                <a href={secondaryCta.href}>
                  <Button size="lg" variant="outline" className={dark ? "text-white border-white hover:bg-white/10 border-2 border-primary" : "border-2 border-primary"} data-testid="button-hero-secondary">
                    {secondaryCta.label}
                  </Button>
                </a>
              )}
