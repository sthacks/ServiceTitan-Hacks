...
const blogPostContent: Record<string, JSX.Element> = {
  "phonetap-built-for-csrs": (
    <div className="prose prose-lg max-w-none text-black [&_p]:text-black [&_li]:text-black [&_h2]:text-black [&_h3]:text-black">
      <p className="lead">
        For most of my career in HVAC, I misunderstood one of the most important roles in the company.
      </p>
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">I Did Every Job. And I Got This One Wrong.</h2>

      <p>
        When I started my HVAC business, I did everything.
      </p>
      ...
      <p>
        The role I underestimated the most was the CSR and dispatch function.
      </p>

      <p>
        I thought it was easy. I did not enjoy it. So I hired for it early and trained for it poorly.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>This is what we do</li>
        <li>This is the service call price</li>
        <li>Put them on the schedule</li>
      </ul>

      <p>
        No real sales training. No objection handling. No emotional intelligence. No feedback loop.
      </p>

      <p>
        I assumed they would just know how to do it.
      </p>
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">CSRs Were Invisible in My Business</h2>

      <p>
        In my company, CSRs were not celebrated.
      </p>

      <p>
        Sales had commissions. Techs had performance metrics. Installers had scorecards.
      </p>

      <p>
        CSRs had booking rate and cancellation rate. If those numbers were even accurate.
      </p>

      <p>
        Without trustworthy data, I only noticed CSRs when something went wrong.
      </p>

      <ul className="list-disc pl-6 space-y-2">
        <li>Booking rate dropped</li>
        <li>A customer complained</li>
        <li>I overheard a bad call</li>
      </ul>

      <p>
        My conclusion at the time was not "my systems are broken". It was "maybe I hired the wrong person".
      </p>
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">When AI Arrived, I Looked for the Wrong Solution First</h2>

      <p>
        When ChatGPT launched, my first thought was simple.
      </p>

      <p>
        "AI voice can replace CSRs."
      </p>

      <p>
        Not because it was the right solution. Because it was a way to avoid a role I never learned how to lead well.
      </p>

      <p>
        At the time, I was running my company remotely. I needed visibility.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Pulling call recordings from ServiceTitan</li>
        <li>Transcribing calls</li>
        <li>Summarizing them</li>
        <li>Dropping summaries into job records</li>
        <li>Scoring sentiment as good, neutral, or bad</li>
        <li>Sending alerts when calls went poorly</li>
      </ul>

      <p>
        That alone helped save customers and escalate issues faster.
      </p>
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">The Data Was Still Lying</h2>

      <p>
        I wanted to understand the call center the same way I understood:
      </p>
      ...
      <p>
        The first thing I needed was accurate call classification:
      </p>
      ...
      <p>
        When I compared call transcripts to how calls were classified, I found a problem.
      </p>

      <p>
        The data was wrong. Not slightly wrong. Very wrong.
      </p>

      <p>
        I checked other companies I was working with. Same issue.
      </p>

      <p>
        Even companies manually reviewing calls had unreliable classifications.
      </p>

      <p>
        Which meant leadership was making decisions based on bad data.
      </p>

      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">CSRs Are the Front Door to All Marketing Spend</h2>
      ...
      <p>
        You can do everything right in marketing. Spend thousands on ads. Rank in search. Build a strong brand.
      </p>

      <p>
        And one phone call can erase all of it.
      </p>

      <p>
        CSRs are not a back office function. They are the gateway to revenue.
      </p>

      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">Why PhoneTAP Exists</h2>

      <p>
        I partnered with Josh Crouch and Tersh Blissett, combining:
      </p>

      <ul className="list-disc pl-6 space-y-2">
        <li>Years of operator experience</li>
        <li>Years of manual call review</li>
        <li>Deep marketing insight</li>
      </ul>

      <p>
        That became PhoneTAP.
      </p>

      <p>
        We trained AI using real calls reviewed by real humans. Not theoretical prompts.
      </p>

      <p>
        Today, we are confident in roughly 98 percent accuracy in call analysis.
      </p>

      <p>
        But accuracy alone was not the goal.
      </p>

      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">I Did Not Want Another Dashboard That Only Management Likes</h2>

      <p>
        When we first built dashboards, they showed:
      </p>
      ...
      <p>
        "What can a CSR actually control here?"
      </p>

      <p>
        A maintenance call is pre-sold. A pricing question is not.
      </p>

      <p>
        One unbooked service call can be far more expensive than five booked tune-ups.
      </p>
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">What CSRs Actually Do That Creates Value</h2>

      <p>
        PhoneTAP looks for things that were previously invisible:
      </p>

      <ul className="list-disc pl-6 space-y-2">
        <li>Objections raised by customers</li>
        <li>Objections successfully overcome</li>
        <li>Upset callers turned satisfied</li>
        <li>Emotional trajectory of each call</li>
        <li>High-stakes moments handled correctly</li>
      </ul>
      ...
      <p>
        A customer asks about price. That is an objection.
      </p>

      <p>
        If handled poorly, the customer says "I will call back" and disappears. If handled well, the customer books immediately.
      </p>

      <p>
        Historically, there was no visibility into that win.
      </p>
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">Celebrate What Is Going Right</h2>

      <p>
        PhoneTAP was not built as a surveillance tool.
      </p>

      <p>
        It is not a "here is what you did wrong" system.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Objections overcome appear on the dashboard</li>
        <li>Upset customers calmed appear on the dashboard</li>
        <li>Positive momentum is visible</li>
        <li>Wins are measurable</li>
      </ul>

      <p>
        Once value is visible, reward becomes possible.
      </p>
      ...
      <p>
        Something CSRs have historically been excluded from because the data was unreliable.
      </p>

      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">Why AI Voice Will Not Replace CSRs Anytime Soon</h2>

      <p>
        Through deep analysis of real calls, I changed my mind.
      </p>

      <p>
        Customers call in with elevated emotion. They want to feel heard. They know when they are talking to a machine.
      </p>

      <p>
        If AI voice takes the easy calls, the remaining calls become harder. Training gets worse, not better.
      </p>

      <p>
        CSRs become even more important.
      </p>

      <h2 className="text-2xl font-bold mt-10 mb-4 font-heading">Built Bottom-Up, Not Top-Down</h2>

      <p>
        Most software is built for ownership. Then forced downward for adoption.
      </p>

      <p>
        PhoneTAP was built for CSRs.
      </p>

      <p>
        When CSRs love a tool:
      </p>

      <ul className="list-disc pl-6 space-y-2">
        <li>Adoption is natural</li>
        <li>Managers see the value</li>
        <li>Ownership supports it</li>
      </ul>

      <p>
        That is how real utilization happens.
      </p>

      <p>
        PhoneTAP exists because I failed CSRs early in my career. It exists to make their impact visible, measurable, and rewarded.
      </p>
