      ...
      <main className="flex-1">
        ...
        <section className="py-10 md:py-24 bg-[#0a0a0a]">
          <div className="mx-auto max-w-5xl px-6 text-center">
            ...
            <p className="mt-5 text-xs text-[#737373] flex items-center justify-center gap-1.5">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
              Your pricebook stays private. Encrypted storage, no AI training on your data, NDA available on request.{" "}
              <a href="/pricebook-overhaul/security" className="underline underline-offset-2 hover:text-[#a3a3a3] transition-colors">
