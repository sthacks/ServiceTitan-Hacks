...
export default function PartnerDetail() {
  ...
  // Redirect jills-office partner slug to its webinar page
  useEffect(() => {
    if (partnerSlug === "jills-office") {
      setLocation("/webinars/live-answering-team");
    }
  }, [partnerSlug]);
  ...
  if (partner.slug === "broccoli-ai") {
    ...
    const DEMO_URL    = "https://broccoliai.partnerlinks.io/wgketa7n3rwp";
  ...
  if (partner.slug === "jills-office") return null;
