...
const config = {
  ...
  webinarSubtitle: "Most home service businesses are leaking revenue without realizing it. They spend heavily on marketing to replace customers they already paid to acquire.",
...
const learningCards = [
  { 
    title: "Why Customers Stop Calling", 
    description: "It's not price - discover the real reasons customers leave." 
  },
  { 
    title: "The Invisible Retention Leak", 
    description: "Find the hidden gaps inside most ServiceTitan workflows." 
  },
  { 
    title: "Automated Rebooking & Referrals", 
    description: "How SmartAC drives automated engagement without manual effort." 
  },
  { 
    title: "4-Step Retention Timeline", 
    description: "The system used by high-performing teams." 
  },
];

const agenda = [
  { time: "00:00", topic: "Why Customers Actually Stop Calling Back (It's Not Price)" },
  { time: "00:15", topic: "The Invisible Retention Leak Inside Most ServiceTitan Workflows" },
  { time: "00:30", topic: "How SmartAC Drives Automated Rebooking and Referrals" },
  { time: "00:45", topic: "The 4-Step Retention Timeline Used by High-Performing Teams" },
  { time: "00:55", topic: "Real-World Results and Common Objections from the Field" },
  { time: "01:05", topic: "Live Q&A" },
];
...
export default function SmartACRetentionWebinar() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <SEO
        ...
        description="Stop paying for the same leads twice. Discover the retention system that keeps members renewing, booking, and referring. Free live webinar for contractors."
        keywords="membership retention, ServiceTitan, SmartAC, contractor marketing, HVAC membership, customer retention"
        canonicalUrl="https://servicetitanhacks.com/webinar/customer-retention"
      />
      ...
      <section className="py-16 md:py-24 px-4 bg-[#ED254E]">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-white/80 mb-8">
            This is a practical, operator-level session for contractors who want higher lifetime value without spending more on leads.
          </p>
          <Button
            size="lg"
            variant="secondary"
