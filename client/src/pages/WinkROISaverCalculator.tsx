...
import { Calculator, ExternalLink, Copy, Calendar, FileText, CheckCircle, DollarSign, TrendingUp, Target } from "lucide-react";
...
const STORAGE_KEY_USER = "wink-roi-saver-user";
...
export default function WinkROISaverCalculator() {
  ...
  useEffect(() => {
    ...
    if (params.get("firstName")) form.setValue("firstName", params.get("firstName")!);
    if (params.get("email")) form.setValue("email", params.get("email")!);
    if (params.get("phoneNumber")) form.setValue("phoneNumber", params.get("phoneNumber")!);
  ...
  const leadMutation = useMutation({
    ...
    onSuccess: (_, data) => {
      ...
      toast({
        title: "Welcome!",
        description: "Your calculator is ready.",
      });
    },
    onError: (error: any) => {
      toast({
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          {!showCalculator ? (
            <Card className="max-w-md mx-auto">
              <CardHeader>
                <CardTitle>See Your Savings</CardTitle>
                <CardDescription>
                  Enter your info to access the calculator and see how much you can save.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(handleLeadSubmit)} className="space-y-4">
                    ...
                    >
                      {leadMutation.isPending ? "Loading..." : "Show My Savings"}
                    </Button>
                  </form>
                </Form>
              </CardContent>
            ...
            <>
              <div className="text-center mb-8">
                <p className="text-lg text-muted-foreground">
                  Welcome{userName ? `, ${userName}` : ""}! See how much money you can save each month and year.
                </p>
                <p className="text-sm text-muted-foreground mt-1">
                  These numbers are estimates. You can change them to match your business.
                </p>
              </div>
