...
import PricebookToolAnalytics from "@/pages/PricebookToolAnalytics";
...
import WebinarLiveAnsweringTeam from "@/pages/WebinarLiveAnsweringTeam";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/admin/overhaul-orders" component={AdminOverhaulOrders} />
      <Route path="/admin/pricebook-tool" component={PricebookToolAnalytics} />
      ...
      <Route path="/webinars/live-answering-team" component={WebinarLiveAnsweringTeam} />
      <Route path="/webinars/archive" component={WebinarLandingPage} />
